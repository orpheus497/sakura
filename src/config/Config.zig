...
asterisk: ?u32 = '*',
auth_fails: u64 = 10,
auto_login_service: [:0]const u8 = "sakura-autologin",
auto_login_session: ?[]const u8 = null,
auto_login_user: ?[]const u8 = null,
battery_sysctl: ?[]const u8 = null,
bg: u32 = 0x00FFFFFF,
bigclock: Bigclock = .none,
bigclock_12hr: bool = false,
bigclock_seconds: bool = false,
blank_box: bool = true,
border_fg: u32 = 0x20000000,
box_position_h: f32 = 0.30,
box_position_v: f32 = 0.62,
box_title: ?[]const u8 = "sakura",
brightness_down_cmd: [:0]const u8 = "/usr/bin/backlight decr 10",
brightness_down_key: ?[]const u8 = "F5",
brightness_up_cmd: [:0]const u8 = "/usr/bin/backlight incr 10",
...
custom_sessions: []const u8 = build_options.config_directory ++ "/sakura/custom-sessions",
default_input: Input = .login,
doom_fire_height: u8 = 6,
doom_fire_spread: u8 = 2,
doom_top_color: u32 = 0x009F2707,
doom_middle_color: u32 = 0x00C78F17,
doom_bottom_color: u32 = 0x00FFFFFF,
dur_file_path: []const u8 = build_options.config_directory ++ "/sakura/example.dur",
dur_offset_alignment: DurOffsetAlignment = .center,
dur_x_offset: i32 = 0,
dur_y_offset: i32 = 0,
edge_margin: u8 = 0,
error_bg: u32 = 0x00FFFFFF,
...
lua_animation_file: []const u8 = build_options.config_directory ++ "/sakura/example.lua",
margin_box_h: u8 = 2,
margin_box_v: u8 = 1,
numlock: bool = false,
path: ?[]const u8 = "/sbin:/bin:/usr/sbin:/usr/bin:/usr/local/sbin:/usr/local/bin",
restart_key: ?[]const u8 = "F2",
sakura_log: ?[]const u8 = "/var/log/sakura.log",
save_file_dir: ?[]const u8 = build_options.config_directory ++ "/sakura",
service_name: [:0]const u8 = "sakura",
session_log: ?[]const u8 = ".local/state/sakura-session.log",
setup_cmd: []const u8 = build_options.config_directory ++ "/sakura/setup.sh",
shell: bool = true,
